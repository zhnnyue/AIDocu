...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Boolean} opts.autorepair Optional; automatically repair input documents that have errors (default is true)
     ...
     */
    this.editDocumentDocxAcceptAllTrackChanges = function(inputFile, opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the editDocumentDocxGetContentControls operation.
     * @callback module:api/EditDocumentApi~editDocumentDocxGetContentControlsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetDocxContentControlsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:api/EditDocumentApi~editDocumentDocxGetContentControlsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetDocxContentControlsResponse}
     */
    this.editDocumentDocxGetContentControls = function(inputFile, callback) {
      var postBody = null;

      // verify the required parameter 'inputFile' is set
      if (inputFile === undefined || inputFile === null) {
        throw new Error("Missing the required parameter 'inputFile' when calling editDocumentDocxGetContentControls");
      }
      ...
      var contentTypes = ['multipart/form-data'];
      var accepts = ['application/json', 'text/json', 'application/xml', 'text/xml'];
      var returnType = GetDocxContentControlsResponse;
    ...
    /**
     * Callback function to receive the result of the editDocumentDocxGetFormFields operation.
     * @callback module:api/EditDocumentApi~editDocumentDocxGetFormFieldsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetDocxGetFormFieldsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:api/EditDocumentApi~editDocumentDocxGetFormFieldsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetDocxGetFormFieldsResponse}
     */
    this.editDocumentDocxGetFormFields = function(inputFile, callback) {
      var postBody = null;

      // verify the required parameter 'inputFile' is set
      if (inputFile === undefined || inputFile === null) {
        throw new Error("Missing the required parameter 'inputFile' when calling editDocumentDocxGetFormFields");
      }
      ...
      var contentTypes = ['multipart/form-data'];
      var accepts = ['application/json', 'text/json', 'application/xml', 'text/xml'];
      var returnType = GetDocxGetFormFieldsResponse;
    ...
    /**
     * Callback function to receive the result of the editDocumentDocxReplaceMultiEditSession operation.
     * @callback module:api/EditDocumentApi~editDocumentDocxReplaceMultiEditSessionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DocumentEditingEditSession} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/MultiReplaceStringRequest} reqConfig Document string replacement configuration input
     * @param {module:api/EditDocumentApi~editDocumentDocxReplaceMultiEditSessionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DocumentEditingEditSession}
     */
    this.editDocumentDocxReplaceMultiEditSession = function(reqConfig, callback) {
      var postBody = reqConfig;

      // verify the required parameter 'reqConfig' is set
      if (reqConfig === undefined || reqConfig === null) {
        throw new Error("Missing the required parameter 'reqConfig' when calling editDocumentDocxReplaceMultiEditSession");
      }
      ...
      var contentTypes = ['application/json', 'text/json', 'application/xml', 'text/xml', 'application/x-www-form-urlencoded'];
      var accepts = ['application/json', 'text/json', 'application/xml', 'text/xml'];
      var returnType = DocumentEditingEditSession;
    ...
    /**
     * Callback function to receive the result of the editDocumentDocxSetFormFields operation.
     * @callback module:api/EditDocumentApi~editDocumentDocxSetFormFieldsCallback
     * @param {String} error Error message, if any.
     * @param {'Blob'} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/DocxSetFormFieldsRequest} reqConfig 
     * @param {module:api/EditDocumentApi~editDocumentDocxSetFormFieldsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'Blob'}
     */
    this.editDocumentDocxSetFormFields = function(reqConfig, callback) {
      var postBody = reqConfig;

      // verify the required parameter 'reqConfig' is set
      if (reqConfig === undefined || reqConfig === null) {
        throw new Error("Missing the required parameter 'reqConfig' when calling editDocumentDocxSetFormFields");
      }
