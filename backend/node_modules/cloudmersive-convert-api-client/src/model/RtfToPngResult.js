...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.RtfToPngResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedPngPage);
  }
  ...
  /**
   * Constructs a new <code>RtfToPngResult</code>.
   * Result of converting a RTF input to a PNG array
   * @alias module:model/RtfToPngResult
   * @class
   */
  ...
  /**
   * Constructs a <code>RtfToPngResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RtfToPngResult} obj Optional instance to populate.
   * @return {module:model/RtfToPngResult} The populated <code>RtfToPngResult</code> instance.
   */
