...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.AutodetectToJpgResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedJpgPage);
  }
  ...
  /**
   * Constructs a new <code>AutodetectToJpgResult</code>.
   * Result of converting a Autodetected Document input to a JPG array
   * @alias module:model/AutodetectToJpgResult
   * @class
   */
  ...
  /**
   * Constructs a <code>AutodetectToJpgResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AutodetectToJpgResult} obj Optional instance to populate.
   * @return {module:model/AutodetectToJpgResult} The populated <code>AutodetectToJpgResult</code> instance.
   */
