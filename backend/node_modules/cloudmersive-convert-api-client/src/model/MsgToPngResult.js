...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.MsgToPngResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedPngPage);
  }
  ...
  /**
   * Constructs a new <code>MsgToPngResult</code>.
   * Result of converting a MSG input to a PNG array
   * @alias module:model/MsgToPngResult
   * @class
   */
  ...
  /**
   * Constructs a <code>MsgToPngResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MsgToPngResult} obj Optional instance to populate.
   * @return {module:model/MsgToPngResult} The populated <code>MsgToPngResult</code> instance.
   */
