...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.KeynoteToPngResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedPngPage);
  }
  ...
  /**
   * Constructs a new <code>KeynoteToPngResult</code>.
   * Result of converting a Keynote input to a PNG array
   * @alias module:model/KeynoteToPngResult
   * @class
   */
  ...
  /**
   * Constructs a <code>KeynoteToPngResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/KeynoteToPngResult} obj Optional instance to populate.
   * @return {module:model/KeynoteToPngResult} The populated <code>KeynoteToPngResult</code> instance.
   */
