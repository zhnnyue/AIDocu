...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.GetDocxTableRowRequest = factory(root.CloudmersiveConvertApiClient.ApiClient);
  }
  ...
  /**
   * The GetDocxTableRowRequest model module.
   * @module model/GetDocxTableRowRequest
   * @version 2.8.0
   */

  /**
   * Constructs a new <code>GetDocxTableRowRequest</code>.
   * Input to a get DOCX table row request
   * @alias module:model/GetDocxTableRowRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>GetDocxTableRowRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetDocxTableRowRequest} obj Optional instance to populate.
   * @return {module:model/GetDocxTableRowRequest} The populated <code>GetDocxTableRowRequest</code> instance.
   */
