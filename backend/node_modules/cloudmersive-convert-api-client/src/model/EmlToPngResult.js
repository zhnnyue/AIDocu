...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.EmlToPngResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedPngPage);
  }
  ...
  /**
   * Constructs a new <code>EmlToPngResult</code>.
   * Result of converting an EML input to a PNG array
   * @alias module:model/EmlToPngResult
   * @class
   */
  ...
  /**
   * Constructs a <code>EmlToPngResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EmlToPngResult} obj Optional instance to populate.
   * @return {module:model/EmlToPngResult} The populated <code>EmlToPngResult</code> instance.
   */
