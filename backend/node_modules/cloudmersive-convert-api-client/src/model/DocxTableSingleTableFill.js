...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.DocxTableSingleTableFill = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.DocxTableTableFillTableRow);
  }
  ...
  /**
   * The DocxTableSingleTableFill model module.
   * @module model/DocxTableSingleTableFill
   * @version 2.8.0
   */

  /**
   * Constructs a new <code>DocxTableSingleTableFill</code>.
   * Single table fill request in a multi-table fill operation
   * @alias module:model/DocxTableSingleTableFill
   * @class
   */
  ...
  /**
   * Constructs a <code>DocxTableSingleTableFill</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocxTableSingleTableFill} obj Optional instance to populate.
   * @return {module:model/DocxTableSingleTableFill} The populated <code>DocxTableSingleTableFill</code> instance.
   */
