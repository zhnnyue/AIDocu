...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.GetDocxPagesRequest = factory(root.CloudmersiveConvertApiClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>GetDocxPagesRequest</code>.
   * Input to a Get Word DOCX Document Pages request
   * @alias module:model/GetDocxPagesRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>GetDocxPagesRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetDocxPagesRequest} obj Optional instance to populate.
   * @return {module:model/GetDocxPagesRequest} The populated <code>GetDocxPagesRequest</code> instance.
   */
