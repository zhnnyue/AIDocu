...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.XmlRemoveAllChildrenWithXPathResult = factory(root.CloudmersiveConvertApiClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>XmlRemoveAllChildrenWithXPathResult</code>.
   * Result of performing a remove all child nodes operation on XML input using XPath
   * @alias module:model/XmlRemoveAllChildrenWithXPathResult
   * @class
   */
  ...
  /**
   * Constructs a <code>XmlRemoveAllChildrenWithXPathResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/XmlRemoveAllChildrenWithXPathResult} obj Optional instance to populate.
   * @return {module:model/XmlRemoveAllChildrenWithXPathResult} The populated <code>XmlRemoveAllChildrenWithXPathResult</code> instance.
   */
