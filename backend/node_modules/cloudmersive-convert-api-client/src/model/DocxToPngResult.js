...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.DocxToPngResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedPngPage);
  }
  ...
  /**
   * Constructs a new <code>DocxToPngResult</code>.
   * Result of converting a DOCX input to a PNG array
   * @alias module:model/DocxToPngResult
   * @class
   */
  ...
  /**
   * Constructs a <code>DocxToPngResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DocxToPngResult} obj Optional instance to populate.
   * @return {module:model/DocxToPngResult} The populated <code>DocxToPngResult</code> instance.
   */
