...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.OdpToJpgResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedJpgPage);
  }
  ...
  /**
   * Constructs a new <code>OdpToJpgResult</code>.
   * Result of converting an ODP input to a JPG array
   * @alias module:model/OdpToJpgResult
   * @class
   */
  ...
  /**
   * Constructs a <code>OdpToJpgResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OdpToJpgResult} obj Optional instance to populate.
   * @return {module:model/OdpToJpgResult} The populated <code>OdpToJpgResult</code> instance.
   */
