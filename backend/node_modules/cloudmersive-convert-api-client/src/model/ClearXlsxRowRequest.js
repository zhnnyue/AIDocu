...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.ClearXlsxRowRequest = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.XlsxWorksheet);
  }
  ...
  /**
   * The ClearXlsxRowRequest model module.
   * @module model/ClearXlsxRowRequest
   * @version 2.8.0
   */

  /**
   * Constructs a new <code>ClearXlsxRowRequest</code>.
   * Input to a Clear-Row request
   * @alias module:model/ClearXlsxRowRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>ClearXlsxRowRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClearXlsxRowRequest} obj Optional instance to populate.
   * @return {module:model/ClearXlsxRowRequest} The populated <code>ClearXlsxRowRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('WorksheetToEdit')) {
        obj['WorksheetToEdit'] = XlsxWorksheet.constructFromObject(data['WorksheetToEdit']);
      }
   ...
   * @member {module:model/XlsxWorksheet} WorksheetToEdit
   */
  exports.prototype['WorksheetToEdit'] = undefined;
  /**
