...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.XmlAddAttributeWithXPathResult = factory(root.CloudmersiveConvertApiClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>XmlAddAttributeWithXPathResult</code>.
   * Result of performing a add attribute node operation on XML input using XPath
   * @alias module:model/XmlAddAttributeWithXPathResult
   * @class
   */
  ...
  /**
   * Constructs a <code>XmlAddAttributeWithXPathResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/XmlAddAttributeWithXPathResult} obj Optional instance to populate.
   * @return {module:model/XmlAddAttributeWithXPathResult} The populated <code>XmlAddAttributeWithXPathResult</code> instance.
   */
