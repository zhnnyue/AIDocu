...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.XlsxToPngResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedPngPage);
  }
  ...
  /**
   * Constructs a new <code>XlsxToPngResult</code>.
   * Result of converting an XLSX input to a PNG array
   * @alias module:model/XlsxToPngResult
   * @class
   */
  ...
  /**
   * Constructs a <code>XlsxToPngResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/XlsxToPngResult} obj Optional instance to populate.
   * @return {module:model/XlsxToPngResult} The populated <code>XlsxToPngResult</code> instance.
   */
