...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveConvertApiClient.EmlToJpgResult = factory(root.CloudmersiveConvertApiClient.ApiClient, root.CloudmersiveConvertApiClient.ConvertedJpgPage);
  }
  ...
  /**
   * Constructs a new <code>EmlToJpgResult</code>.
   * Result of converting an EML input to a JPG array
   * @alias module:model/EmlToJpgResult
   * @class
   */
  ...
  /**
   * Constructs a <code>EmlToJpgResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EmlToJpgResult} obj Optional instance to populate.
   * @return {module:model/EmlToJpgResult} The populated <code>EmlToJpgResult</code> instance.
   */
