...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.MergeJobStatusResult();
  });
  ...
  describe('MergeJobStatusResult', function() {
    it('should create an instance of MergeJobStatusResult', function() {
      // uncomment below and update the code to test MergeJobStatusResult
      //var instance = new CloudmersiveConvertApiClient.MergeJobStatusResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.MergeJobStatusResult);
    });
    ...
    it('should have the property fileOutputResult (base name: "FileOutputResult")', function() {
      // uncomment below and update the code to test the property fileOutputResult
      //var instance = new CloudmersiveConvertApiClient.MergeJobStatusResult();
      //expect(instance).to.be();
    });
