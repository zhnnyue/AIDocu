...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveConvertApiClient.PdfToPngDirectResult();
  });
  ...
  describe('PdfToPngDirectResult', function() {
    it('should create an instance of PdfToPngDirectResult', function() {
      // uncomment below and update the code to test PdfToPngDirectResult
      //var instance = new CloudmersiveConvertApiClient.PdfToPngDirectResult();
      //expect(instance).to.be.a(CloudmersiveConvertApiClient.PdfToPngDirectResult);
    });
